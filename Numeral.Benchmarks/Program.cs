...
namespace Numeral.Benchmarks
{
    ...
    {
        private NDArray<float> MatA;
        private NDArray<float> MatB;
        private NDArray<float> VecA;
        public LinearAlgebraBenchmarks()
        {
            MatA = NDArray.Ones<float>(64, 64);
            MatB = NDArray.Ones<float>(64, 64).Transpose();
            VecA = NDArray.Ones<float>(64);
        }
